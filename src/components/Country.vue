<template>
  <div class="region">
    <div class="text-center pt-4">
      <input type="text" id="searchbox" placeholder="Enter a Country..." class="border border-black mr-3 p-2 rounded-lg">
      <button v-on:click="getCountry" class="border border-gray-600 bg-gray-100 text-gray-800 px-5 py-2 rounded-lg">Submit</button>
    </div>
...
export default {
  ...
  methods: {
    getCountry() {
      ...
      .catch((err) => {
        alert('Please Entry a valid Country!');
        console.log(err);
      })
    }
  },
